                    ...
                    <table class="table mt-5 table-dark px-3" style="border-radius: 10px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <a href=""><i class="fa fa-2x fa-trash text-danger" aria-hidden="true"></i></a>
                                </td>
                                @php
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{ route('payForFarmFirst') }}" method="get">
                            <div class="form-group">
                                ...
                                {{-- <input type="hidden" id="total" value="{{ $farmDetails }}" name="farmDetails"> --}}
                            </div>
                            @csrf
