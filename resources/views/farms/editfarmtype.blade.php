            ...
            <div class="row justify-content-center">
                <div class="col-md-8 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('dashboard/admin/updatefarmtype/'.$thiscat->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent" class="form-control" id="parent">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" @if($category->id==$thiscat->parent) selected @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('parent')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $thiscat->name }}">
                                    @error('name')
                                    <li class="text-danger">{{ $message }}</li>
                                    @enderror
                                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('dashboard/admin/editfarmtype/'.$type->id) }}" class="btn btn-sm btn-success">Edit <i class="fa fa-edit"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
