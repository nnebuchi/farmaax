    ...
    .blog-entry {
        ...
        <div class="row mb-3">
            <div class="col-md-6 offset-md-3 item">
                <h2 class="text-center">My Farm Invetments</h2>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="card card-body myBorder myFarmSelect bg-white">
                    ...
                    <!-- row1 -->
                   <h4 class="text-center">{{ $farm->farm_type }}</h4>
                   ({{ $farm->townname }}- {{ $farm->lganame }} LGA - {{ $farm->statename }})
                   @if ($farm->profit != '')
                       <div class="row text-dark px-4 mt-1">
                           ...
                           <div class="col-6">
                                <div class="text-left">
                                   {{ ($farm->profit/100) * ($farm->unit_cost * $farm->units) }} ({{ $farm->profit }}%)
                                </div>
                           </div>
                       </div>
                   @endif
                   ...
                   @endif
                    ...
                    <div class="row text-dark px-4">
                       ...
                       <div class="col-6">
                            <div class="text-left">
                                @php 
                                    $puredate = explode(' ', $farm->creationDate)
                                @endphp
                                {{date("M jS, Y", strtotime( $farm->creationDate))}}
                            </div>
                       </div>
                   </div>
                   ...
                   <div class="row text-dark px-4">
                    ...
                    @if ($farm->unit_cost != '')
                       <div class="row text-dark px-4">
                           ...
                           <div class="col-6">
                                <div class="text-left">
                                    {{ number_format($farm->unit_cost * $farm->units)  }}
                                </div>
                           </div>
                       </div>
                    @endif
                   ...
                   {{-- <div class="row text-dark px-4 mt-2">
                       <div class="col-12">
                           
                            <button type="button" class="btn primary-btn btn-block" data-toggle="modal" data-target="#staticBackdrop" style="border-radius: 20px; font-weight: bold;">Details</button>
                       </div>
                   </div> --}}
