...
<body>
                        ...
                        <p class="mb-0 d-flex">
                            ...
                            <a href="https://twitter.com/farmaax"
                                class="d-flex align-items-center social-icon justify-content-center"><span
                                    class="social-icon fa fa-twitter social-icon"><i class="sr-only">Twitter</i></span></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container-fluid">
            <a class="navbar-brand logo ml-3" href="{{ url('/') }}"><img src="{{ url('images/logo.jpg') }}" height="100"
                    width="100" class="rounded-circle"></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('lands.index') }}" class="nav-link">Farmaax Lands</a></li>
                    ...
                    @auth
                        ...
                        <li class="nav-item ml-5"><a href="{{ url('farmcart') }}" class="nav-link"
                                style="font-weight: bold; font-size: 25px;"><i class="fa fa-shopping-cart"></i><span
                                    ...
                                    style="position: absolute; top: 20;  font-size: 10px;">{{ $count_cart }}</span></a></li>
                        --}}
