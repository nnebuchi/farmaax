            ...
            <div class="row d-flex">
                @foreach ($lands as $land)
                    ...
                    <div class="myImg d-flex justify-content-center mb-3">
                        <img src="{{ asset('storage/landForSaleCoverImages/'. $land->coverImage) }}" alt="">
                    </div>
                    <!-- row1 -->
                   <h4 class="text-center">{{ $land->landTitle }}</h4>
                   ({{ $land->town }}- {{ $land->lgaName }} LGA - {{ $land->stateName }})
