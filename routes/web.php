...
Route::group(['prefix' => 'dashboard/admin', 'middleware' => 'admin'], function () {
    ...
    // Routes for users referrals
    Route::get('user-referrals/',  'PublicController@allUserReferral')->name('admin.user-referrals');
    Route::get('user-referrals/{id}',  'PublicController@showUserReferral')->name('admin.showUserReferral');
    Route::get('user/referrals/withdrawal-requests',  'PublicController@withdrawalRequest')->name('admin.user-referrals.withdrawals');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('referrals/myearnings', 'UsersController@referralEarnings')->name('referralEarnings');
